...
<div class="container">
    ...
    @endif
    <h1>Editar Página</h1>
    <form action="{{ route('paginas.update', $pagina) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="imagen_destacada" class="form-control @error('imagen_destacada') is-invalid @enderror" value="{{ old('imagen_destacada', $pagina->imagen_destacada) }}">
        ...
        <div class="mb-3">
            ...
            <textarea name="contenido" class="form-control @error('contenido') is-invalid @enderror">{{ old('contenido', $pagina->contenido) }}</textarea>
            @error('contenido')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug', $pagina->slug) }}" required>
            @error('slug')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
